	...
	$.fn.respCarousel = function(args) {
		...
		return $(this).each(function() {
			...
			obj.init = function() {
				...
				// Find visible item and add accessibility support
				$(obj).find('.crsl-item:lt(' + defaults.visible + ')').attr('aria-hidden', 'false' );
			...
			obj.triggerNavs = function() {
				...
				// Previous, Next, Stop, Resume Navigation
			...
			obj.previous = function() {
				...
				$(obj).
					...
					animate({ marginLeft: obj.wrapMargin+'px' }, defaults.speed, function() {
						...
						// Find visible item and add accessibility support
						$(obj).find('.crsl-item').each(function(i, el) {
							var visible = i > 0 && i <= defaults.visible;
			...
			obj.next = function() {
				...
				$(obj).
					...
					animate({ marginLeft: obj.wrapMargin+'px' }, defaults.speed, function() {
						// Active
						$(obj.itemActive).removeClass(defaults.itemClassActive).attr('aria-hidden', 'true');
						$(newItemActive).addClass(defaults.itemClassActive).attr('aria-hidden', 'false');
						if( defaults.infinite ){
